...
public abstract class AbsListViewBaseFragment extends Fragment {
    ...
    protected void startImagePagerActivity(int galleryPosition, int imagePosition) {
        Intent intent = new Intent(getActivity(), SimpleImageActivity.class);
        intent.putExtra(Constants.Extra.FRAGMENT_INDEX, ImagePagerFragment.INDEX);
        intent.putExtra(Constants.Extra.GALLERY_POSITION, galleryPosition);
